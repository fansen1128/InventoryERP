<%@ Page Title="" Language="C#" MasterPageFile="~/Identory.Master" AutoEventWireup="true" CodeBehind="OutStore.aspx.cs" Inherits="Inventory.UI.OutStore" %>
            ...
            <div class="col-sm-12">
                <div class="form-horizontal m-t">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                           <asp:DropDownList runat="server" ID="stno" ClientIDMode="Static" CssClass="form-control" AutoPostBack="true"  OnSelectedIndexChanged="stno_SelectedIndexChanged"/>
                        </div>
                    </div>
                    <div class="form-group">
